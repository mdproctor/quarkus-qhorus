...
class ArtefactAutoClaimTest {
    ...
    void sendMessageWithArtefactRefsAutoClaimsForSender() {
        tools.createChannel("autoclaim-1", "Test channel", null, null);
        ...
        tools.sendMessage("autoclaim-1", "claimer-agent", "command", "process this doc",
                null, null, List.of(artId));
    ...
    void sendMessageWithoutArtefactRefsDoesNotClaim() {
        tools.createChannel("autoclaim-2", "Test channel", null, null);
        ...
        tools.sendMessage("autoclaim-2", "no-ref-agent", "status", "no artefacts here",
                null, null, null);
    ...
    void responseAutoReleasesClaimsFromOriginalQuery() {
        tools.createChannel("autorel-1", "Test channel", null, null);
        ...
        QhorusMcpTools.MessageResult queryResult = tools.sendMessage(
                "autorel-1", "asker", "query", "what about this doc?",
                null, null, List.of(artId));
        ...
        tools.sendMessage("autorel-1", "answerer", "response", "here is the answer",
                corrId, null, null);
    ...
    void doneAutoReleasesClaimsFromOriginalCommand() {
        tools.createChannel("autorel-2", "Test channel", null, null);
        ...
        QhorusMcpTools.MessageResult cmdResult = tools.sendMessage(
                "autorel-2", "commander", "command", "process this",
                null, null, List.of(artId));
        ...
        tools.sendMessage("autorel-2", "worker", "done", "completed",
                corrId, null, null);
    ...
    void declineAutoReleasesClaimsFromOriginalQuery() {
        tools.createChannel("autorel-3", "Test channel", null, null);
        ...
        QhorusMcpTools.MessageResult queryResult = tools.sendMessage(
                "autorel-3", "asker-2", "query", "what about this?",
                null, null, List.of(artId));
        String corrId = queryResult.correlationId();
        ...
        tools.sendMessage("autorel-3", "decliner", "decline", "cannot help with that",
                corrId, null, null);
    ...
    void failureAutoReleasesClaimsFromOriginalCommand() {
        tools.createChannel("autorel-4", "Test channel", null, null);
        ...
        QhorusMcpTools.MessageResult cmdResult = tools.sendMessage(
                "autorel-4", "cmd-agent", "command", "do this",
                null, null, List.of(artId));
        String corrId = cmdResult.correlationId();

        // FAILURE auto-releases
        tools.sendMessage("autorel-4", "fail-agent", "failure", "could not complete",
                corrId, null, null);
    ...
    void handoffDoesNotAutoReleaseClaims() {
        tools.createChannel("autorel-5", "Test channel", null, null);
        ...
        QhorusMcpTools.MessageResult cmdResult = tools.sendMessage(
                "autorel-5", "handoff-cmd", "command", "handle this",
                null, null, List.of(artId));
        String corrId = cmdResult.correlationId();
        ...
        tools.sendMessage("autorel-5", "handoff-agent", "handoff", "passing to someone else",
                corrId, null, null, "instance:someone-else");
    ...
    void autoClaimIsIdempotent() {
        tools.createChannel("autoclaim-idem", "Test channel", null, null);
        ...
        tools.sendMessage("autoclaim-idem", "idem-agent", "status", "first",
                null, null, List.of(artId));
        tools.sendMessage("autoclaim-idem", "idem-agent", "status", "second",
                null, null, List.of(artId));
