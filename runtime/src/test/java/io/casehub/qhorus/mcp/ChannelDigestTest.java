...
class ChannelDigestTest {
    ...
    void digestEmptyChannelReturnsZerosAndNulls() {
        tools.createChannel("cd-empty-1", "Test", null, null);
    ...
    void digestSenderBreakdownIsCorrect() {
        tools.createChannel("cd-sender-1", "Test", null, null);
        tools.sendMessage("cd-sender-1", "alice", "status", "a", null, null, null, null);
        tools.sendMessage("cd-sender-1", "alice", "status", "b", null, null, null, null);
        tools.sendMessage("cd-sender-1", "bob", "status", "c", null, null, null, null);
    ...
    void digestArtefactRefCountIsCorrect() {
        ...
        tools.sendMessage("cd-refs-1", "alice", "status", "msg",
                null, null, List.of(a1.artefactId().toString(), a2.artefactId().toString()), null);
        // Message 2 references artefact 1 again (same UUID, not double-counted)
        tools.sendMessage("cd-refs-1", "bob", "status", "msg2",
                null, null, List.of(a1.artefactId().toString()), null);
    ...
    void digestRecentMessagesRespectLimit() {
        tools.createChannel("cd-limit-1", "Test", null, null);
        for (int i = 0; i < 8; i++) {
            tools.sendMessage("cd-limit-1", "alice", "status", "msg" + i, null, null, null, null);
        }
    ...
    void digestContentTruncatedAt120Chars() {
        tools.createChannel("cd-trunc-1", "Test", null, null);
        String longContent = "x".repeat(200);
        tools.sendMessage("cd-trunc-1", "alice", "status", longContent, null, null, null, null);
    ...
    void digestContentNotTruncatedWhenShort() {
        tools.createChannel("cd-trunc-2", "Test", null, null);
        tools.sendMessage("cd-trunc-2", "alice", "status", "short", null, null, null, null);
    ...
    void digestOldestAndNewestTimestampsPresent() {
        tools.createChannel("cd-ts-1", "Test", null, null);
        tools.sendMessage("cd-ts-1", "alice", "status", "first", null, null, null, null);
        tools.sendMessage("cd-ts-1", "bob", "status", "last", null, null, null, null);
    ...
    void digestReflectsPausedState() {
        tools.createChannel("cd-paused-1", "Test", null, null);
        tools.pauseChannel("cd-paused-1");
    ...
    void e2eHumanReviewsDigestBeforeForceRelease() {
        tools.createChannel("cd-e2e-1", "Review Channel", "BARRIER", "alice,bob");
        ...
        QhorusMcpTools.ForceReleaseResult release = tools.forceReleaseChannel("cd-e2e-1", "bob unavailable");
