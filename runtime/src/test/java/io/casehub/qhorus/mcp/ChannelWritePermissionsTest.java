...
class ChannelWritePermissionsTest {
    ...
    void senderWithMatchingCapabilityTagCanWrite() {
        tools.createChannel("wp-cap-1", "ACL by capability", null, null, "capability:code-review", null, null, null, null);
    ...
    void senderWithoutMatchingCapabilityTagIsRejected() {
        tools.createChannel("wp-cap-2", "ACL by capability", null, null, "capability:code-review", null, null, null, null);
    ...
    void unregisteredSenderCannotMatchCapabilityTag() {
        tools.createChannel("wp-cap-3", "ACL by capability", null, null, "capability:code-review", null, null, null, null);
    ...
    void senderWithMatchingRoleTagCanWrite() {
        tools.createChannel("wp-role-1", "ACL by role", null, null, "role:reviewer", null, null, null, null);
    ...
    void senderWithWrongRoleTagIsRejected() {
        tools.createChannel("wp-role-2", "ACL by role", null, null, "role:reviewer", null, null, null, null);
    ...
    void mixedAclAcceptsInstanceIdAndCapabilityTag() {
        tools.createChannel("wp-mix-1", "Mixed ACL", null, null, "alice,capability:code-review", null, null, null, null);
    ...
    void mixedAclRejectsNonMatchingSender() {
        tools.createChannel("wp-mix-2", "Mixed ACL", null, null, "alice,capability:code-review", null, null, null, null);
    ...
    void setChannelWritersToNullOrBlankClearsAcl() {
        tools.createChannel("wp-scw-2", "Starts with ACL", null, null, "alice", null, null, null, null);
    ...
    void e2eThreeAgentsMixedAcl() {
        ...
        tools.createChannel("wp-e2e-1", "Restricted channel", "APPEND", null, "alice-agent,bob-agent", null, null, null, null);
        ...
        QhorusMcpTools.CheckResult result = tools.checkMessages("wp-e2e-1", 0L, 10, null, null, null);
    ...
    void e2eCapabilityBasedAcl() {
        tools.createChannel("wp-e2e-2", "Review channel", "COLLECT", null, "capability:reviewer", null, null, null, null);
    ...
    void e2eAclAndPauseAreIndependent() {
        tools.createChannel("wp-e2e-3", "Test", "APPEND", null, "alice", null, null, null, null);
