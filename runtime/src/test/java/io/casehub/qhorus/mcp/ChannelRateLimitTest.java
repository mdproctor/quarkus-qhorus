...
class ChannelRateLimitTest {
    ...
    void channelWithNoLimitsAllowsUnlimitedMessages() {
        tools.createChannel("rl-open-1", "Unlimited", null, null, null, null, null, null);

        for (int i = 0; i < 10; i++) {
            final int n = i;
            assertDoesNotThrow(
                    () -> tools.sendMessage("rl-open-1", "sender", "status", "msg" + n, null, null, null, null),
    ...
    void createChannelDetailHasNullRateLimits() {
        QhorusMcpTools.ChannelDetail detail = tools.createChannel(
                "rl-open-2", "No limits", null, null, null, null, null, null);
    ...
    void messagesUnderPerChannelLimitPass() {
        tools.createChannel("rl-ch-1", "Per-channel limit", null, null, null, null, 3, null);

        // First 3 messages pass
        assertDoesNotThrow(() -> tools.sendMessage("rl-ch-1", "alice", "status", "1", null, null, null, null));
        assertDoesNotThrow(() -> tools.sendMessage("rl-ch-1", "alice", "status", "2", null, null, null, null));
        assertDoesNotThrow(() -> tools.sendMessage("rl-ch-1", "alice", "status", "3", null, null, null, null));
    }

    @Test
    @TestTransaction
    void messageAtPerChannelLimitPasses() {
        tools.createChannel("rl-ch-2", "Per-channel limit", null, null, null, null, 2, null);

        assertDoesNotThrow(() -> tools.sendMessage("rl-ch-2", "alice", "status", "1", null, null, null, null));
        assertDoesNotThrow(() -> tools.sendMessage("rl-ch-2", "alice", "status", "2", null, null, null, null),
    ...
    void messageOverPerChannelLimitIsRejectedWithClearError() {
        tools.createChannel("rl-ch-3", "Per-channel limit", null, null, null, null, 2, null);

        tools.sendMessage("rl-ch-3", "alice", "status", "1", null, null, null, null);
        tools.sendMessage("rl-ch-3", "alice", "status", "2", null, null, null, null);

        ToolCallException ex = assertThrows(ToolCallException.class,
                () -> tools.sendMessage("rl-ch-3", "alice", "status", "3", null, null, null, null),
    ...
    void perChannelLimitCountsAcrossAllSenders() {
        tools.createChannel("rl-ch-4", "Per-channel limit", null, null, null, null, 2, null);

        // Two different senders each send one message — together they hit the limit
        tools.sendMessage("rl-ch-4", "alice", "status", "from alice", null, null, null, null);
        tools.sendMessage("rl-ch-4", "bob", "status", "from bob", null, null, null, null);

        // Third message from anyone is rejected
        assertThrows(ToolCallException.class,
                () -> tools.sendMessage("rl-ch-4", "carol", "status", "from carol", null, null, null, null),
    ...
    void rejectedMessageDoesNotIncrementCount() {
        tools.createChannel("rl-ch-5", "Per-channel limit", null, null, null, null, 2, null);

        tools.sendMessage("rl-ch-5", "alice", "status", "1", null, null, null, null);
        tools.sendMessage("rl-ch-5", "alice", "status", "2", null, null, null, null);

        // Third is rejected
        assertThrows(ToolCallException.class,
                () -> tools.sendMessage("rl-ch-5", "alice", "status", "3", null, null, null, null));

        // Fourth is also rejected — count should not have incremented on the rejected message
        assertThrows(ToolCallException.class,
                () -> tools.sendMessage("rl-ch-5", "alice", "status", "4", null, null, null, null),
    ...
    void messagesUnderPerInstanceLimitPass() {
        tools.createChannel("rl-inst-1", "Per-instance limit", null, null, null, null, null, 2);

        assertDoesNotThrow(() -> tools.sendMessage("rl-inst-1", "alice", "status", "1", null, null, null, null));
        assertDoesNotThrow(() -> tools.sendMessage("rl-inst-1", "alice", "status", "2", null, null, null, null));
    }

    @Test
    @TestTransaction
    void messageOverPerInstanceLimitIsRejectedWithClearError() {
        tools.createChannel("rl-inst-2", "Per-instance limit", null, null, null, null, null, 2);

        tools.sendMessage("rl-inst-2", "alice", "status", "1", null, null, null, null);
        tools.sendMessage("rl-inst-2", "alice", "status", "2", null, null, null, null);

        ToolCallException ex = assertThrows(ToolCallException.class,
                () -> tools.sendMessage("rl-inst-2", "alice", "status", "3", null, null, null, null),
    ...
    void perInstanceLimitIsIsolatedBetweenSenders() {
        ...
        tools.createChannel("rl-inst-3", "Per-instance limit", null, null, null, null, null, 2);

        // Alice sends 2 — at her limit
        tools.sendMessage("rl-inst-3", "alice", "status", "a1", null, null, null, null);
        tools.sendMessage("rl-inst-3", "alice", "status", "a2", null, null, null, null);

        // Alice's 3rd is rejected
        assertThrows(ToolCallException.class,
                () -> tools.sendMessage("rl-inst-3", "alice", "status", "a3", null, null, null, null),
                "alice should be rate-limited");

        // Bob still has his own quota — can send 2 freely
        assertDoesNotThrow(() -> tools.sendMessage("rl-inst-3", "bob", "status", "b1", null, null, null, null),
                "bob should have his own independent per-instance quota");
        assertDoesNotThrow(() -> tools.sendMessage("rl-inst-3", "bob", "status", "b2", null, null, null, null));
    }
    ...
    void perChannelLimitCanBeHitBeforePerInstanceLimit() {
        ...
        tools.createChannel("rl-both-1", "Both limits", null, null, null, null, 3, 5);

        tools.sendMessage("rl-both-1", "alice", "status", "1", null, null, null, null);
        tools.sendMessage("rl-both-1", "alice", "status", "2", null, null, null, null);
        tools.sendMessage("rl-both-1", "alice", "status", "3", null, null, null, null);

        // Channel limit hit (3) — even though alice's instance limit (5) is not reached
        assertThrows(ToolCallException.class,
                () -> tools.sendMessage("rl-both-1", "alice", "status", "4", null, null, null, null),
    ...
    void perInstanceLimitCanBeHitBeforePerChannelLimit() {
        ...
        tools.createChannel("rl-both-2", "Both limits", null, null, null, null, 10, 2);

        tools.sendMessage("rl-both-2", "alice", "status", "1", null, null, null, null);
        tools.sendMessage("rl-both-2", "alice", "status", "2", null, null, null, null);

        // Alice's instance limit hit — even though channel is only at 2 of 10
        ToolCallException ex = assertThrows(ToolCallException.class,
                () -> tools.sendMessage("rl-both-2", "alice", "status", "3", null, null, null, null),
    ...
    void eventMessagesBypassRateLimit() {
        tools.createChannel("rl-evt-1", "Rate limited", null, null, null, null, 1, null);
        tools.sendMessage("rl-evt-1", "alice", "status", "1", null, null, null, null);

        // Per-channel limit reached — but EVENT should bypass
        assertDoesNotThrow(
                () -> tools.sendMessage("rl-evt-1", "system", "event", "audit", null, null, null, null),
    ...
    void setChannelRateLimitsAppliesLimitsToExistingChannel() {
        tools.createChannel("rl-scrl-1", "Open initially", null, null, null, null, null, null);

        // No limits — many messages pass
        tools.sendMessage("rl-scrl-1", "alice", "status", "1", null, null, null, null);
        tools.sendMessage("rl-scrl-1", "alice", "status", "2", null, null, null, null);
        tools.sendMessage("rl-scrl-1", "alice", "status", "3", null, null, null, null);
    ...
    void setChannelRateLimitsToNullRemovesLimits() {
        tools.createChannel("rl-scrl-2", "Limited", null, null, null, null, 1, null);
        // Hit the limit
        tools.sendMessage("rl-scrl-2", "alice", "status", "1", null, null, null, null);
        assertThrows(ToolCallException.class,
                () -> tools.sendMessage("rl-scrl-2", "alice", "status", "2", null, null, null, null));
    ...
    void createChannelDetailIncludesRateLimits() {
        QhorusMcpTools.ChannelDetail detail = tools.createChannel(
                "rl-det-1", "Rate limited", null, null, null, null, 10, 3);
    ...
    void listChannelsIncludesRateLimits() {
        tools.createChannel("rl-det-2", "Rate limited", null, null, null, null, 5, 2);
    ...
    void e2eThreeSendersPerChannelLimit() {
        ...
        tools.createChannel("rl-e2e-1", "Shared budget", null, null, null, null, 4, null);

        // Alice sends 2, Bob sends 2 — channel budget exhausted
        tools.sendMessage("rl-e2e-1", "alice", "status", "a1", null, null, null, null);
        tools.sendMessage("rl-e2e-1", "alice", "status", "a2", null, null, null, null);
        tools.sendMessage("rl-e2e-1", "bob", "status", "b1", null, null, null, null);
        tools.sendMessage("rl-e2e-1", "bob", "status", "b2", null, null, null, null);

        // Carol's message is rejected — channel budget gone
        assertThrows(ToolCallException.class,
                () -> tools.sendMessage("rl-e2e-1", "carol", "status", "c1", null, null, null, null),
                "channel budget should be exhausted after alice and bob fill it");

        // Exactly 4 messages stored (not 5)
        QhorusMcpTools.CheckResult result = tools.checkMessages("rl-e2e-1", 0L, 20, null);
    ...
    void e2ePerInstanceLimitDoesNotAffectOtherSenders() {
        ...
        for (int i = 0; i < 2; i++) {
            final int n = i;
            assertDoesNotThrow(() -> tools.sendMessage("rl-e2e-2", "bob", "status", "b" + n, null, null, null, null));
            assertDoesNotThrow(() -> tools.sendMessage("rl-e2e-2", "carol", "status", "c" + n, null, null, null, null));
        }

        // 6 messages total: 2 alice + 2 bob + 2 carol
        QhorusMcpTools.CheckResult result = tools.checkMessages("rl-e2e-2", 0L, 20, null);
    ...
    void e2eRateLimitAndWriteAclCoexist() {
        ...
        tools.createChannel("rl-e2e-3", "ACL + rate limit", null, null, "alice", null, 2, null);

        // alice passes both checks for first 2 messages
        tools.sendMessage("rl-e2e-3", "alice", "status", "1", null, null, null, null);
        tools.sendMessage("rl-e2e-3", "alice", "status", "2", null, null, null, null);

        // alice is now rate-limited
        assertThrows(ToolCallException.class,
                () -> tools.sendMessage("rl-e2e-3", "alice", "status", "3", null, null, null, null));

        // bob is still rejected by write ACL (not rate limiting)
        ToolCallException aclEx = assertThrows(ToolCallException.class,
                () -> tools.sendMessage("rl-e2e-3", "bob", "status", "intrude", null, null, null, null));
